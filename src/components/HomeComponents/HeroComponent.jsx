...
const HeroCenter = function ({ data }) {
  return (
    <div className="w-[100%] sm:w-[90%] md:w-[75%] lg:w-[60%] 2xl:w-[40%] px-4 lg:px-6 flex items-center  absolute top-[10%] md:top-[15%] lg:top-[20%] left-[50%] md:left-[40%] lg:left-[30%] -translate-x-[50%] bg-indigo-950/[.3] z-20 py-4 md:py-8 lg:py-10   shadow-lg shadow-sky-700 flex-wrap flex-col">
      <img
        className="w-[80%] lg:w-[50%]"
        src={tmdbImagePath(data.poster_path)}
        alt="poster path of the image"
      />
      <div className="w-[80%] lg:w-[50%] flex flex-col items-start p-2 gap-2">
